...
def sem2(isActive, lock_isActive, tempo, switch, lock_switch):
...
def sem1(isActive, lock_isActive, tempo, switch, lock_switch):
...
p1 = multiprocessing.Process(target=sem1, args=(isActive, lock_isActive, tempo, switch, lock_switch))
p2 = multiprocessing.Process(target=sem2, args=(isActive, lock_isActive, tempo, switch, lock_switch))
